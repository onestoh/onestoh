...
-- Generated: 2026-06-02 07:26:51

SET NAMES utf8mb4;
SET CHARACTER SET utf8mb4;
SET FOREIGN_KEY_CHECKS=0;

CREATE DATABASE IF NOT EXISTS \`estateyard\` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE \`estateyard\`;
...
CREATE TABLE IF NOT EXISTS \`users\` (
  ...
  \`role\` ENUM('admin','landlord','broker_licensed','broker_unlicensed','tenant','developer','valuer','surveyor','auctioneer','investor','corporate','property_manager','finance') NOT NULL DEFAULT 'tenant',
  \`phone\` VARCHAR(255) NULL,
  \`avatar\` VARCHAR(255) NULL,
  \`is_verified\` TINYINT(1) NOT NULL DEFAULT 0,
  \`verification_tier\` ENUM('none','basic','professional','elite') NOT NULL DEFAULT 'none',
  ...
  INDEX \`users_referred_by_foreign\` (\`referred_by\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`properties\` (
  ...
  \`price_period\` ENUM('night','month','year') NULL,
  ...
  INDEX \`properties_user_id_foreign\` (\`user_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`property_documents\` (
  ...
  \`name\` VARCHAR(255) NOT NULL,
  \`type\` ENUM('title_deed','survey_plan','valuation_report','lease_agreement','other') NOT NULL,
  \`file_path\` VARCHAR(255) NOT NULL,
  \`is_verified\` TINYINT(1) NOT NULL DEFAULT 0,
  \`created_at\` TIMESTAMP NULL,
  \`updated_at\` TIMESTAMP NULL,
  PRIMARY KEY (\`id\`),
  INDEX \`property_documents_property_id_foreign\` (\`property_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`property_saves\` (
  ...
  INDEX \`property_saves_user_id_foreign\` (\`user_id\`),
  INDEX \`property_saves_property_id_foreign\` (\`property_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`hotel_rooms\` (
  ...
  \`room_type\` ENUM('standard','deluxe','suite','penthouse','family','single','double','twin') NOT NULL,
  \`name\` VARCHAR(255) NOT NULL,
  ...
  \`updated_at\` TIMESTAMP NULL,
  PRIMARY KEY (\`id\`),
  INDEX \`hotel_rooms_property_id_foreign\` (\`property_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`leases\` (
  ...
  \`updated_at\` TIMESTAMP NULL,
  PRIMARY KEY (\`id\`),
  INDEX \`leases_property_id_foreign\` (\`property_id\`),
  INDEX \`leases_landlord_id_foreign\` (\`landlord_id\`),
  INDEX \`leases_tenant_id_foreign\` (\`tenant_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`rent_payments\` (
  ...
  \`updated_at\` TIMESTAMP NULL,
  PRIMARY KEY (\`id\`),
  INDEX \`rent_payments_lease_id_foreign\` (\`lease_id\`),
  INDEX \`rent_payments_tenant_id_foreign\` (\`tenant_id\`),
  INDEX \`rent_payments_landlord_id_foreign\` (\`landlord_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`bookings\` (
  ...
  \`type\` ENUM('inspection','airbnb','hotel') NOT NULL DEFAULT 'airbnb',
  ...
  \`cleaning_fee\` DECIMAL(8,2) NOT NULL DEFAULT 0,
  \`service_fee\` DECIMAL(8,2) NOT NULL DEFAULT 0,
  \`status\` ENUM('pending','confirmed','paid','checked_in','checked_out','cancelled','refunded') NOT NULL DEFAULT 'pending',
  ...
  \`host_notified_at\` TIMESTAMP NULL,
  \`auto_confirmed\` TINYINT(1) NOT NULL DEFAULT 1,
  \`created_at\` TIMESTAMP NULL,
  \`updated_at\` TIMESTAMP NULL,
  PRIMARY KEY (\`id\`),
  INDEX \`bookings_property_id_foreign\` (\`property_id\`),
  INDEX \`bookings_room_id_foreign\` (\`room_id\`),
  INDEX \`bookings_guest_id_foreign\` (\`guest_id\`),
  INDEX \`bookings_host_id_foreign\` (\`host_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`property_availability\` (
  ...
  \`reason\` ENUM('booked','owner_blocked','maintenance') NOT NULL DEFAULT 'booked',
  \`booking_id\` BIGINT UNSIGNED NULL,
  \`created_at\` TIMESTAMP NULL,
  \`updated_at\` TIMESTAMP NULL,
  PRIMARY KEY (\`id\`),
  UNIQUE KEY \`property_availability_property_id_blocked_date_unique\` (\`property_id\`, \`blocked_date\`),
  INDEX \`property_availability_property_id_foreign\` (\`property_id\`),
  INDEX \`property_availability_booking_id_foreign\` (\`booking_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`property_pricing_rules\` (
  ...
  \`updated_at\` TIMESTAMP NULL,
  PRIMARY KEY (\`id\`),
  INDEX \`property_pricing_rules_property_id_foreign\` (\`property_id\`),
  INDEX \`property_pricing_rules_room_id_foreign\` (\`room_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`booking_reviews\` (
  ...
  \`updated_at\` TIMESTAMP NULL,
  PRIMARY KEY (\`id\`),
  UNIQUE KEY \`booking_reviews_booking_id_unique\` (\`booking_id\`),
  INDEX \`booking_reviews_reviewer_id_foreign\` (\`reviewer_id\`),
  INDEX \`booking_reviews_property_id_foreign\` (\`property_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`escrow_transactions\` (
  ...
  \`type\` ENUM('sale','deposit','refund') NOT NULL,
  ...
  INDEX \`escrow_transactions_property_id_foreign\` (\`property_id\`),
  INDEX \`escrow_transactions_buyer_id_foreign\` (\`buyer_id\`),
  INDEX \`escrow_transactions_seller_id_foreign\` (\`seller_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`auctions\` (
  ...
  \`bid_increment\` DECIMAL(10,2) NOT NULL DEFAULT 10000.00,
  ...
  \`updated_at\` TIMESTAMP NULL,
  PRIMARY KEY (\`id\`),
  INDEX \`auctions_property_id_foreign\` (\`property_id\`),
  INDEX \`auctions_auctioneer_id_foreign\` (\`auctioneer_id\`),
  INDEX \`auctions_winner_id_foreign\` (\`winner_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`bids\` (
  ...
  \`updated_at\` TIMESTAMP NULL,
  PRIMARY KEY (\`id\`),
  INDEX \`bids_auction_id_foreign\` (\`auction_id\`),
  INDEX \`bids_bidder_id_foreign\` (\`bidder_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`referrals\` (
  ...
  \`updated_at\` TIMESTAMP NULL,
  PRIMARY KEY (\`id\`),
  INDEX \`referrals_referrer_id_foreign\` (\`referrer_id\`),
  INDEX \`referrals_referred_user_id_foreign\` (\`referred_user_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`referral_conversions\` (
  ...
  \`conversion_type\` ENUM('registration','listing','transaction') NOT NULL,
  \`commission\` DECIMAL(10,2) NOT NULL,
  \`status\` ENUM('pending','paid') NOT NULL DEFAULT 'pending',
  \`created_at\` TIMESTAMP NULL,
  \`updated_at\` TIMESTAMP NULL,
  PRIMARY KEY (\`id\`),
  INDEX \`referral_conversions_referral_id_foreign\` (\`referral_id\`),
  INDEX \`referral_conversions_referred_user_id_foreign\` (\`referred_user_id\`),
  INDEX \`referral_conversions_property_id_foreign\` (\`property_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`verifications\` (
  \`id\` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  \`user_id\` BIGINT UNSIGNED NOT NULL,
  \`tier\` ENUM('basic','professional','elite') NOT NULL,
  ...
  INDEX \`verifications_reviewed_by_foreign\` (\`reviewed_by\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`verification_documents\` (
  ...
  \`document_type\` ENUM('national_id','passport','kra_pin','business_reg','bank_statement','utility_bill','photo','other') NOT NULL,
  \`file_path\` VARCHAR(255) NOT NULL,
  \`status\` ENUM('pending','approved','rejected') NOT NULL DEFAULT 'pending',
  \`created_at\` TIMESTAMP NULL,
  \`updated_at\` TIMESTAMP NULL,
  PRIMARY KEY (\`id\`),
  INDEX \`verification_documents_verification_id_foreign\` (\`verification_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`inspections\` (
  ...
  \`updated_at\` TIMESTAMP NULL,
  PRIMARY KEY (\`id\`),
  INDEX \`inspections_property_id_foreign\` (\`property_id\`),
  INDEX \`inspections_inspector_id_foreign\` (\`inspector_id\`),
  INDEX \`inspections_requester_id_foreign\` (\`requester_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`maintenance_requests\` (
  ...
  \`updated_at\` TIMESTAMP NULL,
  PRIMARY KEY (\`id\`),
  INDEX \`maintenance_requests_property_id_foreign\` (\`property_id\`),
  INDEX \`maintenance_requests_tenant_id_foreign\` (\`tenant_id\`),
  INDEX \`maintenance_requests_assigned_to_foreign\` (\`assigned_to\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`messages\` (
  ...
  INDEX \`messages_recipient_id_foreign\` (\`recipient_id\`),
  INDEX \`messages_property_id_foreign\` (\`property_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`notifications_log\` (
  ...
  \`title\` VARCHAR(255) NOT NULL,
  \`body\` TEXT NOT NULL,
  \`type\` ENUM('payment','inspection','document','auction','system','message') NOT NULL DEFAULT 'system',
  \`is_read\` TINYINT(1) NOT NULL DEFAULT 0,
  \`url\` VARCHAR(255) NULL,
  \`created_at\` TIMESTAMP NULL,
  \`updated_at\` TIMESTAMP NULL,
  PRIMARY KEY (\`id\`),
  INDEX \`notifications_log_user_id_foreign\` (\`user_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`developer_projects\` (
  ...
  \`status\` ENUM('planning','construction','completed','selling') NOT NULL DEFAULT 'planning',
  \`completion_date\` DATE NULL,
  \`images\` JSON NULL,
  \`created_at\` TIMESTAMP NULL,
  \`updated_at\` TIMESTAMP NULL,
  PRIMARY KEY (\`id\`),
  INDEX \`developer_projects_developer_id_foreign\` (\`developer_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`valuations\` (
  ...
  \`purpose\` ENUM('sale','mortgage','insurance','other') NOT NULL,
  ...
  \`updated_at\` TIMESTAMP NULL,
  PRIMARY KEY (\`id\`),
  INDEX \`valuations_property_id_foreign\` (\`property_id\`),
  INDEX \`valuations_valuer_id_foreign\` (\`valuer_id\`),
  INDEX \`valuations_client_id_foreign\` (\`client_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \`surveys\` (
  ...
  \`client_id\` BIGINT UNSIGNED NOT NULL,
  \`survey_type\` ENUM('topographic','boundary','subdivision','soil_test','other') NOT NULL,
  \`status\` ENUM('pending','in_progress','completed','delivered') NOT NULL DEFAULT 'pending',
  \`report_url\` VARCHAR(255) NULL,
  \`fee\` DECIMAL(10,2) NOT NULL,
  \`scheduled_date\` DATE NULL,
  ...
  \`updated_at\` TIMESTAMP NULL,
  PRIMARY KEY (\`id\`),
  INDEX \`surveys_property_id_foreign\` (\`property_id\`),
  INDEX \`surveys_surveyor_id_foreign\` (\`surveyor_id\`),
  INDEX \`surveys_client_id_foreign\` (\`client_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
